...
ActiveRecord::Schema.define(version: 20180123121414) do
  ...
  create_table "admins", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC" do |t|
