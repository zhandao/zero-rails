class Api::V1::PermissionsDoc < ApiDoc
  ...
  open_api :index, 'GET permissions list of the specified model.', builder: :index, use: token do
  ...
  open_api :create, 'PATCH update the specified permission.', builder: :success_or_not, use: id_and_token do
  ...
  open_api :destroy, 'DELETE the specified permission.', builder: :success_or_not, use: id_and_token
end
